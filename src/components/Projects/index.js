        ...
        <>
            <div className="projects-browser">
                <section className="project">
                    <div>
                        <Link to ='/Portfolio/projects/quirky-of-diceville' ><img src={ThumbnailQOD} alt='Quirky-of-Diceville thumbnail'  loading='lazy'/></Link>
                    </div>
                    <h1>Solo Development Project</h1>
                </section>
                <section className="project">
                    <div>
                        <Link to ='/Portfolio/projects/robo-run-roo' ><img src={ThumbnailRRR} alt='Robo-Run-Roo thumbnail' loading='lazy'/></Link>
                    </div>
                    <h1>Assignment Project</h1>
                </section>
                <section className="project">
                    <div>
                        <Link to ='/Portfolio/projects/aruval-slasher' ><img src={ThumbnailAS} alt='Aruval-Slasher thumbnail' loading='lazy'/></Link>
                    </div>
